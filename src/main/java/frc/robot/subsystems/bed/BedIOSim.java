...
/** Simulated bed (conveyor) IO using a WPILib DCMotorSim (2x Kraken X60, direct drive). */
public class BedIOSim implements BedIO {
  ...
  public void applyOutputs(BedIOOutputs outputs) {
    switch (outputs.mode) {
      ...
      case VELOCITY -> appliedVoltage = outputs.velocityRPM * BedConstants.kV;
    }

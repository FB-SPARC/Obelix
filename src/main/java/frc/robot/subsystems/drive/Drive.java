...
public class Drive extends FullSubsystem {
  ...
  public Drive(
    ...
    // Publish Field2d to SmartDashboard for Elastic / Shuffleboard visualization
  ...
  /** Sets the auto trajectory preview on the Field2d widget. */
  public void setAutoTrajectory(Pose2d... poses) {

...
public class FieldConstants {
  ...
  /** Feed targets — two landing zones, one on each side of the hub (split by hub center Y). */
  public static class FeedTarget {

    /** Left-side feed target (robot Y > hub center Y, i.e. left of the hub). */
    public static final Translation2d leftPoint = new Translation2d(2, fieldWidth - 2);

    /** Right-side feed target (robot Y < hub center Y, i.e. right of the hub). */
    public static final Translation2d rightPoint = new Translation2d(2, 2);
  }
